...
class FizzicsCode2(Quest):
    ...
    def __init__(self):
        super().__init__('Fizzics Code 2', 'riley', QS('FIZZICSCODE2_QUESTION'))
    ...
    def step_first(self, time_in_step):
        if time_in_step == 0:
            if not Desktop.app_is_running(self.TARGET_APP_DBUS_NAME):
                self.show_hints_message(QSH('FIZZICSCODE2_LAUNCH'))
    ...
    def step_explanation(self, time_in_step):
        if time_in_step == 0:
            Sound.play('quests/step-forward')
            self.show_hints_message(QSH('FIZZICSCODE2_EXPLANATION'))
    ...
    def step_end(self, time_in_step):
        if time_in_step == 0:
            ...
            self.show_message(QS('FIZZICSCODE2_END'), choices=[('Bye', self._confirm_step)])
    ...
    def step_abort(self, time_in_step):
        if time_in_step == 0:
            ...
            self.show_message(QS('FIZZICSCODE2_ABORT'))
