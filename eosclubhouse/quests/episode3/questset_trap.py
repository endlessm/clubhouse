...
class TrapQuestSet(QuestSet):
    ...
    def __init__(self):
        ...
        ClubhouseState()._impl.connect('notify::window-is-visible',
    ...
    def stop_previous_animation_sounds(self):
        for body_animation in self._sounds_by_body_animation:
        ...
        if self.body_animation in self._sounds_by_body_animation:
            self._sounds_by_body_animation = {
                body_animation: self._sounds_by_body_animation[self.body_animation]
            }
    ...
    def _change_animation_sound_volume(self, volume):
        ...
        for uuid in self._sounds_by_body_animation[self.body_animation]:
