...
class PowerUpC1(Quest):

    def __init__(self):
        super().__init__('PowerUpC1', 'saniel')
    ...
    def step_play(self):
        ...
        self.wait_confirm('NOSHRINK')
        self.wait_confirm('FINISHLEVEL')

        # @todo check goal condition: Player picked powerup of type
        # 'upgrade' and ship got shrinkTimer > 0.
