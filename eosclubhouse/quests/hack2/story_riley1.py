...
class Story_Riley1(Quest):
    ...
    __tags__ = ['pathway:web', 'skillset:Narrative', 'difficulty:easy', 'skillset:LaunchQuests']
    __pathway_order__ = 50
    __is_narrative__ = True

    QUESTION_MESSAGES = ['STORY_RILEY1_7']

    def setup(self):
        self._info_messages = self.get_loop_messages('STORY_RILEY1')
