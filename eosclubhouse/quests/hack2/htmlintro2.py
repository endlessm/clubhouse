...
class HTMLIntro2(Quest):
    ...
    def setup(self):
        self._info_messages = self.get_loop_messages('HTMLINTRO2', start=3)
    ...
    def step_launch(self):
        self.open_url_in_browser('https://codepen.io/madetohack/pen/BaaKggj?editors=1000#code-area')
    ...
    def step_main_loop(self, message_index=0):
        ...
        if message_id == self._info_messages[-1]:
            self.wait_confirm(message_id, confirm_label='Sounds fun!')
