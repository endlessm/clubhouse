...
class OnboardTour(Quest):
    ...
    def step_begin(self):
        ...
        self.settingsApp = App('org.gnome.ControlCenter')
        self.browserApp = App('org.google.Chrome')
        # self.officeApp = App('org.libreoffice.LibreOffice.writer')
        self.officeApp = App('org.libreoffice.LibreOfficeIpc0')
    ...
    def step_teachkbm(self):
        ...
        self.onboarding_image('temp_show_ctrl_s.png', size='50% 16:9')
        self.wait_confirm('KB2')
        self.onboarding_clean()
        self.onboarding_image('temp_show_alt_win.png', size='50% 16:9')
        ...
        if self.comp_islaptop:
            ...
            self.onboarding_image('temp_numlock_merged.png', size='50% 16:9')
    ...
    def step_apps_writer(self):
        ...
        # TODO: Ideally we use this...
        # self.ask_for_app_launch(app=self.officeApp, message_id='OPENWRITER')
        #       Or this...
        # self.show_hints_message(message_id='OPENWRITER')
        # self.wait_for_app_in_foreground(app=self.softwareApp)
        #
        # TODO: this works, but it blocks execution and precludes a dialog box,
        #   so we can't use it
        # max_attempts = 50
        # wait_seconds = 0.3
    ...
    def step_search(self):
        ...
        if self.has_connection():
            ...
            # EOS 'fake flatpak' for Chrome breaks
            # self.wait_for_app_in_foreground(app=self.browserApp)
    ...
    def step_settings(self):
        ...
        # TODO: For some reason this doesn't work with the ControlCenter
        # self.show_hints_message(message_id='SETTINGS9')
        # self.wait_for_app_in_foreground(app=self.settingsApp)
        self.onboarding_clean()
    ...
    def step_morethings(self):
        ...
        #     # TODO: if we want this, it will be broken out into a much bigger section
