...
class Story_Saniel1(Quest):
    ...
    __tags__ = ['pathway:operating system', 'skillset:Narrative',
                'difficulty:easy', 'skillset:LaunchQuests', 'skillset:felix']
    ...
    def setup(self):
        self._info_messages = self.get_loop_messages('STORY_SANIEL1')
