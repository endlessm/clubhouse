...
class P5JSGif3(Quest):

    __tags__ = ['pathway:art', 'difficulty:medum', 'since:1.6']
    __pathway_order__ = 627

    def setup(self):
        self._info_messages = self.get_loop_messages('P5JSGIF3', start=2)
    ...
    def step_launch(self):
        self.open_url_in_browser('https://editor.p5js.org/madetohack/sketches/okIyaVEw')
