...
class P5JSSound2(Quest):

    __tags__ = ['pathway:art', 'difficulty:medum', 'since:1.5']
    __pathway_order__ = 621

    def setup(self):
        self._info_messages = self.get_loop_messages('P5JSSOUND2', start=2)
    ...
    def step_launch(self):
        self.open_url_in_browser('https://editor.p5js.org/madetohack/sketches/7djSSUEJ')
