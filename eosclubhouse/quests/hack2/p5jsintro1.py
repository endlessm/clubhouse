...
class P5JSIntro1(Quest):

    __tags__ = ['pathway:art', 'difficulty:medum', 'require:network']
    __pathway_order__ = 551

    def setup(self):
        self._info_messages = self.get_loop_messages('P5JSINTRO1', start=3)
