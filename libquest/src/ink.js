...
var InkList = /*#__PURE__*/function (_Map) {
  ...
  _createClass(InkList, [{
    ...
    value: function Union(otherList) {
      ...
      var _iterator4 = _createForOfIteratorHelper(otherList),
          _step4;
    ...
    value: function Without(listToRemove) {
      ...
      var _iterator6 = _createForOfIteratorHelper(listToRemove),
          _step6;
    ...
    value: function Contains(otherList) {
      var _iterator7 = _createForOfIteratorHelper(otherList),
          _step7;
    ...
    value: function ListWithSubRange(minBound, maxBound) {
      ...
      var _iterator8 = _createForOfIteratorHelper(ordered),
          _step8;
    ...
    get: function get() {
      ...
      if (this.origins != null) {
        var _iterator13 = _createForOfIteratorHelper(this.origins),
            _step13;
        ...
        try {
          for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
            ...
            var _iterator14 = _createForOfIteratorHelper(origin.items),
                _step14;
    ...
    get: function get() {
      ...
      if (this.origins != null) {
        var _iterator15 = _createForOfIteratorHelper(this.origins),
            _step15;
        ...
        try {
          for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
            ...
            var _iterator16 = _createForOfIteratorHelper(origin.items),
                _step16;
...
var IntValue = /*#__PURE__*/function (_Value) {
  _inherits(IntValue, _Value);

  var _super3 = _createSuper(IntValue);

  function IntValue(val) {
    _classCallCheck(this, IntValue);

    return _super3.call(this, val || 0);
  }
...
var FloatValue = /*#__PURE__*/function (_Value2) {
  _inherits(FloatValue, _Value2);

  var _super4 = _createSuper(FloatValue);

  function FloatValue(val) {
    _classCallCheck(this, FloatValue);

    return _super4.call(this, val || 0.0);
  }
...
var StringValue = /*#__PURE__*/function (_Value3) {
  _inherits(StringValue, _Value3);

  var _super5 = _createSuper(StringValue);
...
var DivertTargetValue = /*#__PURE__*/function (_Value4) {
  _inherits(DivertTargetValue, _Value4);

  var _super6 = _createSuper(DivertTargetValue);

  function DivertTargetValue(targetPath) {
    _classCallCheck(this, DivertTargetValue);

    return _super6.call(this, targetPath);
  }
...
var VariablePointerValue = /*#__PURE__*/function (_Value5) {
  _inherits(VariablePointerValue, _Value5);

  var _super7 = _createSuper(VariablePointerValue);
  ...
  function VariablePointerValue(variableName) {
    ...
    _this3 = _super7.call(this, variableName);
...
var ListValue = /*#__PURE__*/function (_Value6) {
  _inherits(ListValue, _Value6);

  var _super8 = _createSuper(ListValue);
  ...
  _createClass(Container, [{
    ...
    value: function AddContent(contentObjOrList) {
      if (contentObjOrList instanceof Array) {
        ...
        var _iterator = _createForOfIteratorHelper(contentList),
            _step;
    ...
    value: function AddContentsOfContainer(otherContainer) {
      ...
      var _iterator2 = _createForOfIteratorHelper(otherContainer.content),
          _step2;
    ...
    value: function BuildStringOfHierarchy() {
      ...
      var _iterator3 = _createForOfIteratorHelper(this.namedContent),
          _step3;
      ...
      if (onlyNamed.size > 0) {
        ...
        var _iterator4 = _createForOfIteratorHelper(onlyNamed),
            _step4;
    ...
    get: function get() {
      ...
      var _iterator5 = _createForOfIteratorHelper(this.namedContent),
          _step5;
      ...
      var _iterator6 = _createForOfIteratorHelper(this.content),
          _step6;
    ...
    set: function set(value) {
      ...
      if (existingNamedOnly != null) {
        var _iterator7 = _createForOfIteratorHelper(existingNamedOnly),
            _step7;
...
function () {
  ...
  }(InkObject); // tslint:disable:variable-name
  ...
  var JsonSerialisation = /*#__PURE__*/function () {
    ...
    _createClass(JsonSerialisation, null, [{
      ...
      value: function ListToJArray(serialisables) {
        ...
        var _iterator = _createForOfIteratorHelper(serialisables),
            _step;
      ...
      value: function DictionaryRuntimeObjsToJObject(dictionary) {
        ...
        var _iterator2 = _createForOfIteratorHelper(dictionary),
            _step2;
      ...
      value: function RuntimeObjectToJToken(obj) {
        ...
        if (intVal) return intVal.value; // var floatVal = obj as FloatValue;

        var floatVal = asOrNull(obj, FloatValue);
        if (floatVal) return floatVal.value; // var strVal = obj as StringValue;
        ...
        if (glue) return '<>'; // var controlCmd = obj as ControlCommand;
        ...
        if (varAss) {
          ...
          var _jObj3 = {};
          _jObj3[key] = varAss.variableName; // Reassignment?
        ...
        if (voidObj) return 'void'; // var tag = obj as Tag;
      ...
      value: function InkListToJObject(listVal) {
        ...
        var _iterator4 = _createForOfIteratorHelper(rawList),
            _step4;
      ...
      value: function ListDefinitionsToJToken(origin) {
        ...
        var _iterator5 = _createForOfIteratorHelper(origin.lists),
            _step5;
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            var _iterator6 = _createForOfIteratorHelper(def.items),
                _step6;
...
var CallStack = /*#__PURE__*/function () {
  ...
  _createClass(CallStack, [{
    ...
    value: function GetJsonToken() {
      ...
      var _iterator3 = _createForOfIteratorHelper(this._threads),
          _step3;
...
var VariablesState = /*#__PURE__*/function () {
  ...
  _createClass(VariablesState, [{
    ...
    value: function SetGlobal(variableName, value) {
      ...
      this._globalVariables.set(variableName, value); // TODO: Not sure !== is equivalent to !value.Equals(oldValue)
    ...
    set: function set(value) {
      ...
      if (value) {
        ...
        if (this._changedVariables != null) {
          var _iterator2 = _createForOfIteratorHelper(this._changedVariables),
              _step2;
  ...
  _createClass(StoryState, [{
    ...
    value: function PushToOutputStream(obj) {
      ...
      if (text !== null) {
        ...
        if (listText !== null) {
          var _iterator = _createForOfIteratorHelper(listText),
              _step;
    ...
    value: function PushEvaluationStack(obj) {
      ...
      if (listValue) {
        ...
        if (rawList.originNames != null) {
          ...
          var _iterator2 = _createForOfIteratorHelper(rawList.originNames),
              _step2;
    ...
    get: function get() {
      if (this._outputStreamTextDirty) {
        ...
        var _iterator3 = _createForOfIteratorHelper(this._outputStream),
            _step3;
    ...
    get: function get() {
      if (this._outputStreamTagsDirty) {
        ...
        var _iterator4 = _createForOfIteratorHelper(this._outputStream),
            _step4;
    ...
    get: function get() {
      ...
      var _iterator5 = _createForOfIteratorHelper(this._currentChoices),
          _step5;
      ...
      obj['inkSaveVersion'] = this.kInkSaveStateVersion; // Not using this right now, but could do in future.
    ...
    set: function set(value) {
      ...
      this.OutputStreamDirty(); // currentChoices = Json.JArrayToRuntimeObjList<Choice>((JArray)jObject ["currentChoices"]);
      ...
      this.previousRandom = parseInt(jObject['previousRandom']); // var jChoiceThreads = jObject["choiceThreads"] as JObject;

      var jChoiceThreads = jObject['choiceThreads'];

      var _iterator6 = _createForOfIteratorHelper(this._currentChoices),
          _step6;
  ...
  _createClass(Story, [{
    ...
    value: function VisitChangedContainersDueToDivert() {
      ...
      while (currentContainerAncestor && (this._prevContainers.indexOf(currentContainerAncestor) < 0 || currentContainerAncestor.countingAtStartOnly)) {
        ...
        var enteringAtStart = currentContainerAncestor.content.length > 0 && currentChildOfContainer == currentContainerAncestor.content[0]; // Mark a visit to this container
        ...
        return true;
          ...
          switch (evalCommand.commandType) {
            ...
            case ControlCommand.CommandType.EndString:
              ...
              var _iterator = _createForOfIteratorHelper(contentStackForString),
                  _step;
                ...
                foundValue = new IntValue(_count);
                  ...
                  if (foundValue == null) {
                    ...
                    if (defaultVal != null) {
                      ...
                      foundValue = defaultVal; // Save for future usage, preventing future errors
    ...
    value: function CallExternalFunction(funcName, numberOfArguments) {
      ...
      var foundExternal = typeof func !== 'undefined'; // Try to use fallback function?
      ...
      var funcResult = func(args); // Convert return value (if any) to the a type that the ink engine can use
    ...
    value: function ValidateExternalBindings() {
      ...
      if (c === null && o === null) {
        ...
        var _iterator2 = _createForOfIteratorHelper(c.content),
            _step2;
        ...
        var _iterator3 = _createForOfIteratorHelper(c.namedContent),
            _step3;
    ...
    value: function VariableStateDidChangeEvent(variableName, newValueObj) {
      ...
      if (typeof observers !== 'undefined') {
        ...
        var _iterator5 = _createForOfIteratorHelper(observers),
            _step5;
    ...
    value: function TagsAtStartOfFlowContainerWithPathString(pathString) {
      ...
      var _iterator6 = _createForOfIteratorHelper(flowContainer.content),
          _step6;
    ...
    get: function get() {
      ...
      var _iterator7 = _createForOfIteratorHelper(this._state.currentChoices),
          _step7;
